...
Hello_again_undefined.jpg SCREENSHOT newpar,
...
Belmont_Paul_Women's_Equality.jpg SCREENSHOT newpar,
Showpage_for_park.jpg SCREENSHOT newpar, 
...
")
    ...
    Top_of_page.jpg SCREENSHOT newpar,
    Plant_selection.jpg SCREENSHOT newpar,
    ...
    Featured_plant.jpg SCREENSHOT newpar,
    ...
    Head_shoulders.jpg SCREENSHOT newpar,
    INSERT LINK newpar,
    ...
    Turn_cats_into_plants.jpg SCREENSHOT newpar,
    Plants_to_cats_in_plant_selection.jpg SCREENSHOT newpar,
    Plants_to_cats_in_garden_and_plant_selection.jpg SCREENSHOT newpar,
    Featured_plant.jpg SCREENSHOT newpar,
    insert PHOTO newpar,
    ...
    *The cat pictures are of my cat James who died last year, so I actually wouldn't want to chase him from the garden! newpar,
    ...
    post_three=Post.create(title: "Getting the Monsters Under Control in a Single-Page Application", paragraphs: "Last week I learned a lot while working on the Monsters Lab on learn.co. While I am still figuring out how to meet some of the deliverables, I thought I would post about the things I have managed to do with it so far. newpar,
        ...
        Monsters_lab.jpg SCREENSHOT newpar,
        ...
        Monsters_lab_update_form.jpg SCREENSHOT newpar,
    ...
    Solution.jpg SCREENSHOT newpar,
    Another_solution.jpg SCREENSHOT newpar,
    ...
    wrong_path_for_lab_1.jpg SCREENSHOT newpar,
    ...
    wrong_path_for_lab_2.jpg SCREENSHOT newpar,
    ...
    INSERT LINK newpar,
    wrong_path_for_lab_3.jpg SCREENSHOT newpar,
    ...
    Lab_description.jpg SCREENSHOT newpar,
    ...
    Solution_first_blog.jpg SCREENSHOT newpar,
    When I call binding.pry on this, this is what I see: newpar,
    Solution_result.jpg SCREENSHOT newpar,
    ...
    Title_x_quantity.jpg SCREENSHOT newpar,
    But this is how that turned out: newpar,
    Bookbookbook.jpg SCREENSHOT newpar,
    ...
    Split_method.jpg SCREEN SHOT newpar,
    ...
    Splitting_with_k.jpg SCREENSHOT newpar,
    did this: newpar,
    Splitting_with_k_results.jpg SCREENSHOT newpar,
    ...
    Nows_the_time.jpg SCREENSHOT newpar,
    Or, it tells us, we could split along each letter, like this: newpar,
    Hello_split.jpg SCREENSHOT newpar,
    to give us this: newpar,
    Book_by_the_letter.jpg SCREENSHOT newpar,
    ...
    Mellow_yellow.jpg SCREENSHOT newpar,
    ...
    Adding_a_comma_to_interpolation.png SCREEN SHOT newpar,
    and got this: newpar,
    Interpolating_with_comma_no_split_result.png SCREENSHOT newpar, 
    It looked like I was getting closer, so I edited the above to also include a space after the comma, like this: newpar,
    Interpolating_with_comma_and_space.jpg newpar,    
    to get this: newpar,  
    Result_for_interpolating_with_comma_and_space.jpg SCREENSHOT newpar,   
    ...
    Results_without_flatten.jpg SCREENSHOT newpar,  
    ...
    Splitting_along_white_space_copy.jpg SCREENSHOT newpar,    
